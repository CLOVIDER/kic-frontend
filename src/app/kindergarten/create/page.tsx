      ...
      <section className="relative">
        ...
        <Card className="w-[940px] h-489 py-27 bg-transparent !shadow-none">
          <CardHeader className="w-full flex justify-between px-51 items-start">
            <header className="w-500 relative flex flex-col gap-5">
              <Input
                placeholder="어린이집 이름"
                value={name}
                onValueChange={setName}
                wrapperClassName="font-bold text-[#FFAB2D]"
              ...
              <Input
                ...
                wrapperClassName="top-45"
                className="text-15 font-medium p-2"
              />
            </header>

            <motion.div className="w-270 flex flex-col gap-3 mt-7">
          ...
          <CardBody className="w-full overflow-x-hidden">
            <div className="mt-27 grid grid-cols-3 pl-51 w-fit gap-17">
              <motion.div className="flex gap-20 w-[840px] h-153">
                {images.map((src) => (

...
// import { Qna } from '@/components/qna/type/Qna'
...
//                 <span
//                   className={qna.answered ? 'text-[#7dbc72]' : 'text-[#ffab2d]'}
//                 >
//                   {qna.answered ? '[답변완료]' : '[문의중]'}{' '}
//                 </span>
//                 <span className="">{qna.title}</span>
//               </div>
//               <div className="mt-11 ml-21 w-[150px] h-[14px] text-[#828282] text-10">
//                 <span className="w-[53px]">{qna.date}</span>
//                 <span className="ml-9 w-[1px]">|</span>
//                 <span className="ml-9 w-[40px]">{qna.author}</span>
//               </div>
//             </Fragment>
//           ))}
//         </div>

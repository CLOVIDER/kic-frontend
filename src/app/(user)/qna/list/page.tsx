...
export default function Page() {
  ...
  const handleSearch = () => {
    ...
    router.push('/qna/list?page=1'); // 검색 후 첫 페이지로 이동
  };

  const handlePageChange = (page: number) => {
    router.push(`/qna/list?page=${page}`);
  };
    ...
    <QnaLayout>
        <div className="absolute w-[1280px] h-[720px] bg-white flex-col flex justify-between">
            <div className="w-[787px] h-[602px] mt-39 ml-256 border-1 border-solid border-[#00000014] rounded-xl overflow-hidden shadow-md">
                ...
                <div className="ml-21 w-[118px] h-[39px] text-32 font-inter font-bold">문의사항</div>
                <div className="p-3 mt-7 ml-53 w-[63px] h-[37px] rounded-3 border border-[#d5d1d1] text-center text-14">제목</div>
                <input
                ...
                {paginatedNotices.map((notice) => (
                    ...
                    <div className="ml-24 mt-18 w-[371px] h-[29px] text-20">
                      <span className={notice.answered ? 'text-[#7dbc72]' : 'text-[#ffab2d]'}>
            ...
            <div className="flex ml-265 mt-33 w-[787px] h-[28px] justify-center">
                ...
                <button
                    ...
                    currentPage === index + 1 ? 'bg-[#ff9f00] text-[#ffffff]' : 'bg-[#f1f2f6]'
                    } rounded-4`}

  ...
  return (
    <QnaLayout>
      ...
      <div className="w-[787px] h-[602px] mt-39 ml-256 border-1 border-solid border-[#00000014] rounded-xl overflow-hidden shadow-md">
        <div className="mt-22 ml-36 text-32 font-inter font-bold h-[39px]">문의사항 작성</div>
        <div className="flex relative mt-16 ml-48 w-[451px] h-[24px]">
          ...
          <div className="relative ml-20" onClick={handleToggle} style={{ cursor: 'pointer' }}>
            <div
        ...
        <div className="flex mt-8 ml-[556px] w-[211px] h-[31px]">
          <button className="w-[98px] h-[31px] bg-white border border-[#fdba74] font-bold text-[#fb923c] rounded-full text-sm" onClick={moveBack} >
            작성취소
          </button>

...
export default function LeftSection({ name, date, ifCC }: LeftSectionProps) {
  return (
    <div className="h-[547px] w-[366px] mt-87 ml-123 flex flex-col items-center">
      ...
      <Image className="relative mt-24" alt="" src="/images/boy-standing-front.svg" width={208.89} height={249.85} priority />
      <div className="w-342 h-110 rounded-2xl border border-solid border-[#ffaa2c]">
        <div className="flex w-194 h-72 mt-19 ml-74">
          <div className="w-93 h-70 mr-20 text-16 text-center text-[#FFAB2D]">
            <div>입사일</div>
            <div className="mt-22">사내 부부 여부</div>
          </div>
          <div className="w-81 h-72 text-[#666666] text-16 text-center">
            <div>{date}</div>
            <div className='mt-22'>{ifCC ? "O" : "X"}</div>
          </div>
        </div>
      </div>
    </div>
